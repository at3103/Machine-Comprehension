...
tol = [0.00001, 0.0001, 0.001, 0.01, 0.1, 0.002]
for e in lrn:
	for t in tol:
		for k in range(0,n_x-1):
			clf = LinearSVR(epsilon=e, tol=t, C=1.0, loss='epsilon_insensitive', 
			...
			print "LSVRegressor Accuracy is ", ac_score, "epsilon is", e, "tol is", t
			...
			df.to_csv(os.path.join(output_file_path,"LSVR_prediction_eps_"+str(e)+"_tol_"+str(t)+ "_" + str(k)+".csv"))
