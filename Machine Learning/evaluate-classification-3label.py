...
def get_max_predictions(prediction_dict):
    ...
    for qid in prediction_dict.keys():
        answer_dict = defaultdict(list)
        for constituent in prediction_dict[qid]:
            if constituent[0] == 'Y':
                answer_dict['Y'].append(constituent[1])
            elif constituent[0] == 'M':
                answer_dict['M'].append(constituent[1])
            elif constituent[0] == 'N':
